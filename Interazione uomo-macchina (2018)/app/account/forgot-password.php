    ...
    if(count($errors) == 0)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          $confirm_url = lang("CONFIRM")."\n".$websiteUrl."forgot-password.php?confirm=".$userdetails["activationtoken"];  //PERCORSO ASSOLUTO
          //$confirm_url = lang("CONFIRM")."\n".BASE_DIR."forgot-password.php?confirm=".$userdetails["activationtoken"];
          $deny_url = ("DENY")."\n".$websiteUrl."forgot-password.php?deny=".$userdetails["activationtoken"];  //PERCORSO ASSOLUTO
          //$deny_url = ("DENY")."\n".BASE_DIR."forgot-password.php?deny=".$userdetails["activationtoken"];
...
<input type="submit" class="btn btn-primary" name="new" id="newfeedform" value="Reimposta Password" />
</div>
      ...
      <div class="clear"></div>
            <!--<p style="margin-top:30px; text-align:center;"><a href="<?php echo $websiteUrl; ?>">Home Page</a>-->    <!--PERCORSO ASSOLUTO-->
                <p style="margin-top:30px; text-align:center;"><a href="<?php echo BASE_DIR; ?>">Home Page</a>
            </p>
            <div class="clear">
            </div>
</body>
