...
<?php
if (isset($_REQUEST['flag'])) { //se sto accedendo da menù rapido imposto l'id task scelto nel menu rapido valutando l'esistenza del flag inviato da menù rapido
    
   $id_task = $_REQUEST['task']; //$_REQUEST se prelevo l'id task dal menu rapido
}

else {
   $id_task = (isset($_SESSION['task_id']) ? $_SESSION['task_id'] : $_REQUEST['task']); //Recupero Identificativo del task su cui lavorare 
}
...
if(isset($_REQUEST['task'])) {
    ...
    $_SESSION['ob'] = $_REQUEST['obiettivo'];//setto l'obiettivo richiesto da menu rapido
}
...
$_SESSION['ob'] = $_POST['taskobiettivo'];
}
...
<html>
    ...
    <title>Show Heatmap UTAssistant</title>
        <!--
         <style>
	...
	<body>
        ...
        <iframe id ="iframe_id" src="<?php echo $url ?>"  width="<?php echo $width ?>" height="<?php echo $height ?>"allowfullscreen>  
        </iframe>  
