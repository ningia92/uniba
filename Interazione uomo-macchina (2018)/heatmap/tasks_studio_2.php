...
<html>
	<head>
        ...
        <title>Pagine Tasks Heatmap UTAssistant</title>
	...
	<body>
		...
		<h4 align="center"><?php echo $r['obiettivo']; echo " - "; echo  $r2['obiettivo'] ?></h4>
		...
		<div class="container-fluid">
            <br />
             <div class="row">
            <div class="col-lg-3"> <!-- MENU RAPIDO HEATMAP -->
              <a href="tasks_studio.php">
                  <span class="h5">
                    <span class="glyphicon glyphicon-arrow-left"></span> <u>Indietro</u></span></a>
            <div class="panel panel-default">
        		 <div class="panel-heading"><b>Menù rapido</b></div>
...
<?php
            ...
            if ( strcmp ($row2,$r2['obiettivo']) == 0 ){ //se il task è quello corrente nella pagina lo evidenzio nel menù

                echo "<a href=\"javascript:menufunc('menu".$key2."')\"><span style='background-color:#90EE90'>$row2</span></a><br><br>";
                echo "<div id='menu".$key2."'  style=\"display: block;\">";//esplodo il menù se corrisponde al task corrente

                                                        }

            else { //altrimenti non evidenzio il task
            ...
            foreach($pagine_task as $row3) //foreach sulle pagine aperte durante il task
            {
                ...
                In questo caso invio anche variabile flag settata = 1 per capire in heatmap_studio.php che sto accedendo da menu rapido e
                settare così la variabile $id_task non considerando quella di sessione che potrebbe esser già avvalorata.
                */
                echo "&nbsp&nbsp&nbsp- "; //spazio
                echo "<a href='heatmap_studio.php?task=".$id."&url=".$row3."&obiettivo=".$row2."&flag=1' target='_blank'><i>$row3</i></a><br><br>";
        ...
        <?php
           ...
           ?>
            ...
            <div class="col-lg-9">
            <div class="panel panel-default">
        		 <div class="panel-heading"><b>Pagine Visualizzate Task</b></div>
    	 		 <div class="panel-body">
                 <form action=heatmap_studio.php method="post" target="_blank"> <!-- target="_blank" PER APRIRE NUOVA PAGINA -->
            ...
            while($row = mysql_fetch_array($Dati)) {
                        ...
                        echo '<tr><td>'
                                ...
                                <input id="taskobiettivo" type="hidden" name="taskobiettivo" value="'.$_SESSION['ob'].'"hidden></input>
                                </td>
                                </tr>';
                                                    }
