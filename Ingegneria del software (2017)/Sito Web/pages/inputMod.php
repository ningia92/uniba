...
<body class="bg-dark">
	...
	<section id="">
	<div id="divform">
		<form method = "POST" action = "ModForm.php">
			Inserire il numero passaporto del reperto da modificare: <input type="name" name = "NumPassaporto" id="NumPassaporto" action ="modForm.php"><br>
			<br>
