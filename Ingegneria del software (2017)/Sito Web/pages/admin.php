	...
	<section id="">
        <div class="container">
            <div class="col-lg-8 col-lg-offset-2 text-center">
				<h2 class="section-heading" id="welcome">Administrator management page</h2>
				<hr class="light">
				<br><br><br>
				<h3 class="text-faded">Choose what to do</h3>
				<a href="reperti.php" class="page-scroll btn btn-default btn-xl sr-button" id="repButton">Reperti <br>management</a>
				<a href="dipendenti.php" class="page-scroll btn btn-default btn-xl sr-button" id="dipButton">Employees <br>management</a>
            </div>
        </div>
    </section>
	<!-- jQuery -->
