...
<body class="bg-dark">
	...
	<section id="">
	<div id="divform">
		<form method = "POST" action = "modificaform.php">

		Inserisci l\'ID del dipendente da modificare: <input type="name" name = "ID" style="color: #1D1D1D">
		<br>
		<input class="button alert" type="submit" value="Conferma" id="button">
